...
assert.match(review, /vps-collector/);
assert.match(review, /research-briefs/);
assert.match(review, /오늘 작성 가능/);
assert.match(standard, /3\.3 운영 화면/);
...
assert.match(standard, /주제 제안 cron/);
assert.match(standard, /작성 보류\*\*는 규칙/);
assert.match(standard, /최근 수집 24시간/);
assert.match(review, /작성 보류/);
assert.match(review, /reviewBriefsAfterCollection/);
assert.match(review, /주제 제안/);
