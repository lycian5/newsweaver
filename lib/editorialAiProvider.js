...
const { ARTICLE_RESPONSE_SCHEMA, buildArticleMessages, normalizeArticlePayload } = require('./editorialAi');
...
module.exports = { PROVIDERS, TIERS, aiEnabled, generateEditorialProposal, resolveEditorialAiRoute, resolveRealtimeAiRoute };
