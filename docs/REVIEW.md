...
| 소재 선별 | 리서치 브리프 | https://newsweaver.vercel.app/research-briefs | 기본 큐는 오늘 작성 가능 소재. 요약으로 판단해 바로 초안 전환 |
...
리서치 브리프는 작성 가능 / 작성 보류 / 보류 카드가 기본이고, 필터는 접혀 있습니다. 목록에 두 줄 요약이 있고, 작성 가능이면 검토 시작 없이 초안으로 넘깁니다. 가능 판정은 발행일·공고일을 쓰며 수집일을 쓰지 않습니다. 수집 상태 카드를 누르면 수집 운영으로 갑니다.
