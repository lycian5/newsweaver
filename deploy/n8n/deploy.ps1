...
Invoke-Step "Upload Agent Reach scripts and workflows" {
    ...
    & scp (Join-Path $ProjectDir "lib\freeCollection.js") (Join-Path $ProjectDir "lib\editorialPolicy.js") (Join-Path $ProjectDir "lib\koreanNewsRss.js") (Join-Path $ProjectDir "lib\briefDigest.js") (Join-Path $ProjectDir "lib\briefSummaryReviewJob.js") (Join-Path $ProjectDir "lib\editorialAi.js") (Join-Path $ProjectDir "lib\editorialAiProvider.js") (Join-Path $ProjectDir "lib\editorialAiBudget.js") (Join-Path $ProjectDir "lib\openai.js") (Join-Path $ProjectDir "lib\openaiModels.js") "${RemoteHost}:${RemoteDir}/lib/"
